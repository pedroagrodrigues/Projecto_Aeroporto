...
//Gera Um Numero Para o Bilhete de Voo(falta fazer a verificaÁ„o se o numero j· existe)
int generate_ticket() {
	int ticket_number;
...
// Cria um Novo Avi„o Para a AproximaÁ„o
...
/*
>>>>>>> parent of 05b5cdc... Implementa√ß√£o das fun√ß√µes de Emerg√™ncia em listas ligadas, ainda n√£o totalmente funcionais, falta fazer impress√£o dos voos selecionados.
int emergency_select(aviao * select, int size) {
	...
	while (1) {
		while (!(cin >> opt))
		{
			cin.clear(); //Previne loop na introduÁ„o de cratÈres n„o numÈricos
			while (cin.get() != '\n') continue;
			cout << "ERRO opÁ„o inv·lida\n";
		}
...
int emergencia(aviao * pista, aviao * aproximacao, aviao * descolagem) {
	...
	while (1) {
		...
		cout << "\n----------------------------------------------------------------------------\n";
		cout.width(55);
		cout << right << "Entrou no modo de EmergÍncia!\n";
		cout << "----------------------------------------------------------------------------\n\n";
		cout << "1 - Selecione o Voo em EmergÍncia.\n";
		cout << "2 - Selecione o Voo a Descolar. \n";
		cout << "c - Confirma a SeleÁ„o.\n";
		cout << "0 - Cancelar.\n";
		switch (_getch()) {
		case '1'://Sub SeleÁ„o para aterragem
			...
			break;
		case '2'://Submenu SeleÁ„o para Descolar
...
>>>>>>> parent of 05b5cdc... Implementa√ß√£o das fun√ß√µes de Emerg√™ncia em listas ligadas, ainda n√£o totalmente funcionais, falta fazer impress√£o dos voos selecionados.
				...
				cout << "Faltou seleccionar um avi„o a levantar.\n";
			else if (selectE[0] == -1 && selectE[1] != -1)
				cout << "Faltou seleccionar um avi„o a aterrar.\n";
			else cout << "N„o foram selecionados aviıes.\n";
			cout << endl;
			pausa;
			limpar;
			break;
